...
Based on `app_spec.txt`, create a file called `feature_list.json` with as many detailed
end-to-end test cases as needed to prove the application is complete. This file is the single source
